...
var Launcher = function (_Component) {
  ...
  Launcher.prototype.componentDidUpdate = function componentDidUpdate(prevProps, prevState) {
    if (this.props.isOpen !== prevProps.isOpen) {
      var event = new CustomEvent('TOGGLE_WEBCHAT', { detail: this.props.isOpen });

      window.parent.dispatchEvent(event);
    } else if (this.state.isOpen !== prevState.isOpen) {
      var _event = new CustomEvent('TOGGLE_WEBCHAT', { detail: this.state.isOpen });

      window.parent.dispatchEvent(_event);
    }
  };
