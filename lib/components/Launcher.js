  ...
  Launcher.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(MessageCount, { count: this.props.newMessagesCount,
          isOpen: isOpen
        }),
        ' ',
        _react2.default.createElement('img', { className: "sc-open-icon",
          src: _closeIcon2.default
        }),
        ' ',
        _react2.default.createElement('img', { className: "sc-closed-icon",
          src: _logoNoBg2.default
        }),
        ' '
      ),
      ' ',
      _react2.default.createElement(_ChatWindow2.default, { messageList: messageList,
