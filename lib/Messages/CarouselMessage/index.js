...
var CarouselMessage = (_temp = _class = function (_Component) {
    ...
    CarouselMessage.prototype.render = function render() {
        ...
        var CarouselList = this.props.data.map(function (item, i) {
            return _react2.default.createElement(_CarouselItem2.default, _extends({}, item, { onCarouselClick: _this2.props.onCarouselClick, key: i }));
        });
