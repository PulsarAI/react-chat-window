...
var _CarouselMessage = require('./CarouselMessage');

var _CarouselMessage2 = _interopRequireDefault(_CarouselMessage);

var _WidgetMessage = require('./WidgetMessage');

var _WidgetMessage2 = _interopRequireDefault(_WidgetMessage);

var _chatIcon = require('./chat-icon.svg');
...
var Message = function (_Component) {
    ...
    Message.prototype._renderMessageOfType = function _renderMessageOfType(type) {
        switch (type) {
            ...
            case 'carousel':
                return _react2.default.createElement(_CarouselMessage2.default, _extends({}, this.props.message, { onCarouselClick: this.props.onCarouselClick }));
            case 'widget':
                return _react2.default.createElement(_WidgetMessage2.default, this.props.message);
            default:
